...
export class TerminalNotebookHandler {
   ...
   */
  static create(notebookEditor?: vscode.NotebookEditor): TerminalNotebookHandler {
  ...
  async insertCommandCell(row: CommandRow): Promise<void> {
    ...
    this.notebookEditor.revealRange(range, vscode.NotebookEditorRevealType.Default);
