...
suite("NewTerminalSessionManager Tests", () => {
    ...
    test("should set and retrieve session data for a terminal", async () => {
        ...
        // Create session
        const session = await TerminalSessionManager.registerSession(mockTerminal);
        ...
        assert.strictEqual(
            TerminalSessionManager.retrieveDataBuffer(mockTerminal),
            dataBuffer,
        );
    });
    ...
    test("should set and get XtermParser correctly", async () => {
        ...
        const result =
            TerminalSessionManager.getSession(mockTerminal).xtermParser;
